...
export default function AiScreen() {
  ...
  const toggleSelected = useCallback((id: string) => {
    ...
    setSelectedIds((prev: Record<string, boolean>) => ({ ...prev, [id]: !prev[id] }));
  ...
  const selectedMessages = useMemo(() => {
    ...
    return messages.filter((m: ChatMessage) => ids.has(m.id));
  ...
  const removePendingAttachment = useCallback((key: string) => {
    ...
    setPendingAttachments((prev: typeof pendingAttachments) => prev.filter((x: typeof prev[number]) => x.key !== key));
  ...
  const pickImage = useCallback(async (fromCamera: boolean) => {
    ...
    try {
      ...
      setPendingAttachments((prev: typeof pendingAttachments) => {
  ...
  const send = useCallback(async () => {
    ...
    setMessages((prev: ChatMessage[]) => [...prev, nextUser, nextAi]);
    ...
    try {
      ...
      if (streaming) {
        ...
        await aiChatStream({
          ...
          onEvent: (event) => {
            ...
            if (event.type === "delta") {
              ...
              setMessages((prev: ChatMessage[]) => prev.map((m: ChatMessage) => (m.id === assistantId ? { ...m, content } : m)));
        ...
        setMessages((prev: ChatMessage[]) => prev.map((m: ChatMessage) => (m.id === assistantId ? { ...m, content: res.message.content } : m)));
  ...
  const quickSelect = useCallback(() => {
    ...
    setSelectedIds((prev: Record<string, boolean>) => ({ ...prev, [quickTarget.id]: true }));
        ...
        >
          ...
          <View className="flex-row items-center justify-between">
            ...
            {selectionMode ? (
              ...
              <View className="flex-row items-center" style={{ gap: 10 }}>
                ...
                <Pressable onPress={clearSelection} style={({ pressed }: { pressed: boolean }) => ({ padding: 8, opacity: pressed ? 0.7 : 1 })}>
              ...
              {selectionMode ? (
                ...
                <>
                  ...
                  <Pressable
                    ...
                    style={({ pressed }: { pressed: boolean }) => ({ padding: 8, opacity: pressed ? 0.7 : selectedCount ? 1 : 0.35 })}
                ...
                <>
                  ...
                  {messages.some((m: ChatMessage) => m.role === "assistant" && m.content.trim().length > 0) ? (

                    <Pressable

                      onPress={() => {

                        const latest = [...messages].reverse().find((m: ChatMessage) => m.role === "assistant" && m.content.trim().length > 0) ?? null;
                  ...
                  <Pressable onPress={newConversation} accessibilityRole="button" accessibilityLabel="New conversation" style={({ pressed }: { pressed: boolean }) => ({ padding: 8, opacity: pressed ? 0.7 : 1 })}>
          ...
          <View className="mt-3 flex-row items-center" style={{ gap: 10, flexWrap: "wrap" }}>
            ...
            <Pressable
              ...
              onPress={() => setStreaming((v: boolean) => !v)}
                  ...
                  <FadeIn key={m.id}>
                    ...
                    <View className={m.role === "user" ? "items-end" : "items-start"}>
                      ...
                      <Pressable
                        ...
                        style={({ pressed }: { pressed: boolean }) => ({ opacity: pressed ? 0.92 : 1 })}
        ...
        <View className="px-4 pb-8">
          ...
          {pendingAttachments.length > 0 ? (
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 10, gap: 10 }}>
              ...
              {pendingAttachments.map((a: typeof pendingAttachments[number]) => (
                ...
                >
                  ...
                  >
                    ...
                    <Pressable
                      ...
                      style={({ pressed }: { pressed: boolean }) => ({ position: "absolute", top: 6, right: 6, opacity: pressed ? 0.7 : 1, backgroundColor: "rgba(0,0,0,0.5)", borderRadius: 999, padding: 4 })}
          ...
          >
            ...
            <Pressable
              ...
              style={({ pressed }: { pressed: boolean }) => ({ paddingRight: 10, opacity: pressed ? 0.7 : canAttach ? 1 : 0.35 })}
        ...
        >
          ...
          <View style={{ flexDirection: "row", gap: 10, marginTop: 14, flexWrap: "wrap" }}>
            ...
            <Pressable
              ...
              style={({ pressed }: { pressed: boolean }) => ({ paddingVertical: 10, paddingHorizontal: 12, borderRadius: 999, backgroundColor: pressed ? "rgba(255,255,255,0.10)" : "rgba(255,255,255,0.08)" })}
            ...
            <Pressable
              ...
              style={({ pressed }: { pressed: boolean }) => ({ paddingVertical: 10, paddingHorizontal: 12, borderRadius: 999, backgroundColor: pressed ? "rgba(37,211,102,0.22)" : "rgba(37,211,102,0.14)" })}
            ...
            <Pressable onPress={() => {}} style={{ backgroundColor: "#0b141a", borderRadius: 16, padding: 14 }}>
              ...
              <View style={{ flexDirection: "row", justifyContent: "flex-end", gap: 10, marginTop: 14 }}>
                ...
                <Pressable
                  ...
                  style={({ pressed }: { pressed: boolean }) => ({ paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, backgroundColor: pressed ? "rgba(255,255,255,0.10)" : "rgba(255,255,255,0.08)" })}
        ...
        >
          ...
          <View style={{ flexDirection: "row", flexWrap: "wrap", gap: 12, justifyContent: "space-between" }}>
            ...
            <Pressable
              ...
              style={({ pressed }: { pressed: boolean }) => ({ width: "30%" as any, alignItems: "center", paddingVertical: 10, opacity: !canAttach ? 0.6 : pressed ? 0.7 : 1 })}
