        ...
        >
          <View style={{ flex: 1, justifyContent: "center" }}>
            <View style={{ alignItems: "center", marginBottom: 18 }}>
              ...
              <Text style={{ color: Colors.dark.textPrimary, fontSize: 26, fontWeight: "900" }}>Create account</Text>
            ...
            >
              <Text style={{ color: Colors.dark.textSecondary, fontSize: 12, marginBottom: 8 }}>Name</Text>
              <TextInput
                value={name}
              ...
              <View style={{ marginTop: 14 }}>
                <Text style={{ color: Colors.dark.textSecondary, fontSize: 12, marginBottom: 8 }}>Confirm Password</Text>
                <TextInput
            ...
            <View className="mt-6 flex-row justify-center">
              ...
              <Link href="/(auth)/login" asChild>
                <Text style={{ color: Colors.primaryBlue, fontWeight: "800" }}>Login</Text>
              </Link>
            </View>
          </View>
        </ScrollView>
